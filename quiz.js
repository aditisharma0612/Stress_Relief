document.getElementById('quiz-form').addEventListener('submit', function(event) {
  ...
  let resultText;
  if (totalScore <= 3) {
      resultText = "Your stress level is low. Keep up the good work!";
  } else if (totalScore <= 6) {
      resultText = "Your stress level is moderate. Consider some relaxation techniques.";
  } else {
      resultText = "Your stress level is high. It may be helpful to talk to someone.";
  }
